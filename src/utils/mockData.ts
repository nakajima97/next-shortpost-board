...
export const mockPosts: Post[] = [
  ...
  },
  {
    id: 3,
    handle_name: '開発者',
    content: 'TypeScriptとTailwind CSSの組み合わせが最高です。shadcn/uiも使いやすい。',
  ...
  },
  {
    id: 4,
    handle_name: '学生',
    content: 'プログラミングの勉強頑張ってます！今日はReactのhooksについて学びました。',
  ...
  },
  {
    id: 5,
    handle_name: 'デザイナー',
    content: 'UI/UXデザインを考えるのが楽しい。ユーザビリティを重視した設計を心がけています。',
